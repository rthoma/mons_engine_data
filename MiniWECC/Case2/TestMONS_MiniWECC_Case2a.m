...
ParamAMB(k).RMSeMax.vmag = NaN(1,4); %[NaN 0.6 0.1 0.1]; %kV
ParamAMB(k).RMSeMax.f = NaN(1,4); %[NaN 100 2 1]; %10*milliHz
ParamAMB(k).RMSeMax.mw = NaN(1,4); %[NaN 4 0.3 0.1]; %MW
ParamAMB(k).RMSeMax.mvar = NaN(1,4); %[NaN 4 0.3 0.1]; %MVAR
