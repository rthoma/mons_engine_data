...
ConfigDerived.MW(2).DerivedName = 'Bus 126 to 33 MW';
ConfigDerived.MW(2).SigName = {'Bus 33 V', 'Bus 126 to 33 I'};
ConfigDerived.MW(2).ScaleFac = 1;
...
ConfigDerived.MVAR(2).DerivedName = 'Bus 126 to 33 MVAR';
ConfigDerived.MVAR(2).SigName = {'Bus 33 V', 'Bus 126 to 33 I'};
ConfigDerived.MVAR(2).ScaleFac = 1;
...
k = 2;
ParamAMB(k).Name = 'AMB 2';
ParamAMB(k).MWname = 'Bus 126 to 33 MW';
ParamAMB(k).ADname = 'Bus 33 f';
ParamAMB(k).MVARname = 'Bus 126 to 33 MVAR';
ParamAMB(k).VMAGname = 'Bus 33 VMAG';
ParamAMB(k).TfftSynD = 50;
ParamAMB(k).TfftGov = 400;
ParamAMB(k).Twin = 15*60;
...
for k=1:2
    ...
    ylabel('MVAR')
    subplot(413)
    kD = find(strcmp(ConfigDerived.MAG(1).DerivedName,{DerivedOut.Name}));
    plot(T./60,V,'k','linewidth',2)
    hold on
    plot(T./60,DerivedOut(kD).Data,'r')
    ylabel('V')
    subplot(414)
    kD = find(strcmp(ConfigDerived.AngleDerivative(1).DerivedName,{DerivedOut.Name}));
